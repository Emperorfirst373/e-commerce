...
router.post('/addProduct', isLogin, (req, res) => {
  ...
  form.parse(req, (err, fields, file) => {
    ...
    let newPath = 'C://full-stack/workshop-ecom/app/public/images/';
...
router.get('/reportSalePerDay', isLogin, async (req, res) => {
  ...
  let arr = [];
  let arrYears = [];
  let arrMonths = ['มกราคม', 'กุมภาพันธ์', 'มีนาคม', 'เมษายน', 'พฤษภาคม', 'มิถุนายน', 'กรกฏาคม', 'สิงหาคม', 'กันยายน', 'ตุลาคม', 'พฤศจิกายน', 'ธันวาคม'];
